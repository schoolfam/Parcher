            ...
            studentViewModel.findStudentBySectionId(teacher.section_id).observe(this, Observer {students->
                ...
                students.forEach {student->
                    ...
                    userViewModel.findUserById(student.user_id).observe(this, Observer {
                        ...
                        attendanceViewModel.findAttendanceByDateAndSection(date.time,teacher.section_id).observe(this, Observer {
                            val attendance = it
                            ...
                            adapter.replaceItems(users,userViewModel,studentViewModel,attendanceViewModel,teacher.section_id,arguments?.getString("current_date")!!,attendance)
                        })
