...
class TeacherPostAssessmentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Data Binding
        var binding : com.schoolfam.parcher.databinding.FragmentTeacherPostAssessmentBinding
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_teacher_post_assessment, container, false)
                    ...
                    assessmentViewModel.findAssessmentByStudentIdAndSubjectId((subjectSpinner.selectedItem as Subject).id,student!!.id!!).observe(this,
                        Observer { assessments->
                            ...
                            if (assessments.isEmpty()){
                               ...
                               val cAssessment = assessments.find { assessment-> assessment.assessment_type_id == assessmentType.id}
                                if (cAssessment==null){
        ...
        postAssessmentButton.setOnClickListener {
            ...
            if (scoreEditText.text.toString().startsWith(" ")||scoreEditText.text.toString() == "")
            {
                ...
                else if(assessmentType.id == 6L && scoreEditText.text.toString().toDouble()>40)
                {
                    ...
                    findNavController().navigate(R.id.action_global_teacherPostAssessmentFragment,bundle)
                }
