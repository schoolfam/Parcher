...
class ParentAttendanceMenu : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_parent_attendance_menu, container, false)
    }
...
//            fragmentTransaction.replace(R.id.parent_nav_host_fragment, attendanceFragment)
//            fragmentTransaction.addToBackStack(null)
//            fragmentTransaction.commit()
            findNavController().navigate(R.id.action_parentAttendanceMenu_to_parentChildAttendanceFragment2,bundle)
