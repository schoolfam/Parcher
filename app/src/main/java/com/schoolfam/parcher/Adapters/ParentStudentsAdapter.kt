...
//            fragmentTransaction.replace(R.id.parent_nav_host_fragment, fragment)
//            fragmentTransaction.addToBackStack(null)
//            fragmentTransaction.commit()
            navController.navigate(R.id.action_parentChildrenFragment_to_parentViewAssessmentFragment,bundle)
...
//            fragmentTransaction.addToBackStack(null)
//            fragmentTransaction.commit()
            navController.navigate(R.id.action_parentChildrenFragment_to_parentAttendanceMenu,bundle)
    ...
    fun replaceItems(students: List<User>,fragmentManager: FragmentManager ,navController: NavController) {
