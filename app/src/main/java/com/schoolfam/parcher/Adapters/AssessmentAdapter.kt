...
//            fragmentTransaction.replace(R.id.teacher_nav_host_fragment, fragment)
//            fragmentTransaction.addToBackStack(null)
//            fragmentTransaction.commit()

            navController.navigate(R.id.action_teacherAssessmentStudentsFragment_to_teacherPostAssessmentFragment,bundle)
...
//            fragmentTransaction.addToBackStack(null)
//            fragmentTransaction.commit()
            navController.navigate(R.id.action_teacherAssessmentStudentsFragment_to_teacherViewAssessmentFragment,bundle)
    ...
    fun replaceItems(students: List<User>,sectionId:Long,fragmentManager: FragmentManager,navController: NavController) {
